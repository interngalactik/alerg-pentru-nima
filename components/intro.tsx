  ...
  return (
    <section className="flex-col md:flex-col flex md:justify-between mt-16 mb-16 md:mb-12 text-white">
      <h4 className="text-2xl font-medium mb-8">
        Susține <a href="https://sanctuarnima.ro" className="underline hover:text-green-700 duration-200 transition-colors" target='_blank'>Sanctuarul Nima</a> alături de alte <span className="text-green-700 font-bold">{donors}</span> de persoane.
      </h4>
